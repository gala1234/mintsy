...
const OrderPrintPage: React.FC<OrderPrintPageProps> = ({
  ...
  const handleAddToCart = () => {
    ...
    router.push(`/checkout?type=canvas&id=${artworkId}&option=${selectedOption.id}&quantity=${quantity}`);
  };
  ...
  return (
    <PageContainer>
      <div className="max-w-7xl mx-auto">
        ...
        <h1 className="text-3xl md:text-4xl font-bold mb-8 font-serif-accent text-center">Order a Print</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-3xl p-4 shadow-sm mb-8 lg:mb-0 lg:sticky lg:top-24">
            ...
            <h2 className="hidden lg:block text-xl font-bold mt-4 text-center">{artworkTitle}</h2>
          ...
          <div>
              ...
              {PRINT_OPTIONS.map((option) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-dark/70 text-sm">Premium quality, ready to hang</p>
                  </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm mb-8">
              ...
              <div className="flex justify-between items-center mb-2">
                ...
                <span>€{selectedOption.price} × {quantity}</span>
              </div>
            ...
            <p className="text-center text-dark/60 mt-4">
              Or <a href="/pricing" className="text-blue-600 hover:underline">unlock this artwork</a> without suscibing
            </p>
