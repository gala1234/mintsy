...
interface SchemaMarkupProps {
  pageName: 'home' | 'create' | 'howItWorks' | 'pricing' | 'about' | 'faq';
}
...
const SchemaMarkup: React.FC<SchemaMarkupProps> = ({ pageName }) => {
  ...
  const websiteSchema = {
    ...
    name: 'Mintsy.ai',
    url: 'https://mintsy.ai',
    description: 'Create AI-generated art, mint as NFTs, or order canvas prints',
    potentialAction: {
      '@type': 'SearchAction',
  ...
  switch (pageName) {
    ...
    case 'create':
      pageSpecificSchema = {
        ...
        description: 'Transform your ideas into stunning AI-generated artwork with simple text prompts. Customize styles, colors, and composition.',
    ...
    case 'howItWorks':
      pageSpecificSchema = {
        ...
        description: 'Learn how to transform text prompts into AI artwork, customize your creations, and mint them as NFTs or order canvas prints.',
        step: [
          {
            '@type': 'HowToStep',
    ...
    case 'pricing':
      pageSpecificSchema = {
        ...
        description: 'Unlimited AI art generation, NFT minting, and canvas printing options',
        offers: {
          '@type': 'AggregateOffer',
          lowPrice: '0',
          highPrice: '29.99',
