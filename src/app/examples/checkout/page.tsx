...
export default function CheckoutExample() {
  ...
  return (
    <div className="container mx-auto py-12 px-4">
      {!showCheckout ? (
        <>
          <h1 className="text-3xl md:text-4xl font-bold mb-8 font-serif-accent">Checkout Example</h1>
              ...
              <div key={product.id} className="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="p-6">
                  <span className="inline-block px-3 py-1 rounded-full text-xs font-semibold bg-blue-100 text-blue-700 mb-3">
                    {product.type === 'nft' ? 'NFT' : 
                     product.type === 'download' ? 'HD Download' : 'Canvas Print'}
                  </span>
