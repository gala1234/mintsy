...
export default function ModalsShowcase() {
  ...
  const [limitType, setLimitType] = useState<'generation' | 'download' | 'mint'>('generation');
  ...
  return (
    <div className="container mx-auto py-12 px-4">
      <h1 className="text-3xl md:text-4xl font-bold mb-8 font-serif-accent">Mintsy.ai Modals Showcase</h1>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        {/* Paywall Modal Section */}
        <div className="bg-white rounded-xl shadow-sm overflow-hidden p-6">
          <h2 className="text-2xl font-bold mb-4">Paywall Modal</h2>
          <p className="mb-6">This modal displays subscription options and microtransactions for premium features.</p>
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden p-6">
          ...
          <p className="mb-6">This modal displays when a user has reached usage limits for different features.</p>
