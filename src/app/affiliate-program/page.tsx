    ...
    <div className="container mx-auto px-6 py-12">
      ...
      <div className="max-w-3xl mx-auto mb-12">
        <p className="text-xl mb-6">
          Share the magic of AI art creation and earn rewards. Join the
          Mintsy.ai Affiliate Program and earn commissions for every new user
          who signs up through your referral.
        </p>
        ...
        <div className="bg-mint-light/30 p-8 rounded-xl shadow-sm mb-12">
          ...
          <ol className="list-decimal pl-5 space-y-3">
            ...
            <li>
              Earn 15% commission on all purchases made by users you refer
            </li>
        ...
        <div className="text-center">
          <LinkButton href="/register?affiliate=true">
